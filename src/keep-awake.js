...
// `prevent-display-sleep` не даёт погаснуть экрану и уснуть системе, но НЕ
// сбрасывает HID idle time — политики принудительного логаута по
// бездействию (если такие настроены в системе) это не отменяет.
